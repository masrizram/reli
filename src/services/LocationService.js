...
export class LocationService {
    ...
    getDefaultHotspots() {
        return [
            ...
            { id: 2, name: 'Kuningan Business District', type: 'office', latitude: -6.2297, longitude: 106.8317, demand: 'high' },
            ...
            // Transportasi
            { id: 7, name: 'Stasiun Gambir', type: 'transport', latitude: -6.1667, longitude: 106.8333, demand: 'high' },
            { id: 8, name: 'Bandara Soekarno-Hatta', type: 'transport', latitude: -6.1256, longitude: 106.6559, demand: 'high' },
            { id: 9, name: 'Stasiun Tanah Abang', type: 'transport', latitude: -6.1867, longitude: 106.8133, demand: 'medium' },
            
            // Residential
            { id: 10, name: 'Kelapa Gading', type: 'residential', latitude: -6.1581, longitude: 106.9106, demand: 'medium' },
            { id: 11, name: 'Pondok Indah', type: 'residential', latitude: -6.2642, longitude: 106.7831, demand: 'medium' },
            { id: 12, name: 'Kemang', type: 'residential', latitude: -6.2614, longitude: 106.8161, demand: 'medium' },
            
            // Entertainment
            { id: 13, name: 'Senayan City', type: 'entertainment', latitude: -6.2297, longitude: 106.8019, demand: 'medium' },
            { id: 14, name: 'SCBD', type: 'entertainment', latitude: -6.2297, longitude: 106.8019, demand: 'high' },
            
            // Restaurant Areas
            { id: 15, name: 'PIK Avenue', type: 'restaurant', latitude: -6.1081, longitude: 106.7411, demand: 'medium' },
